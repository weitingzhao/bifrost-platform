...
func (h *Handler) HandlePostgresBackupStatus(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, http.StatusOK, h.svc.PostgresBackupStatus(r.Context()))
}

func (h *Handler) HandleTriggerPostgresBackup(w http.ResponseWriter, r *http.Request) {
	resp, err := h.svc.TriggerPostgresBackup(r.Context())
