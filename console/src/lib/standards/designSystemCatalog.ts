...
export const PAGE_COMPOSITION: PageCompositionAct[] = [
  {
    ...
    examples: [
      ...
      'Launch Research: LaneStateStrip + AI Deploy Research — not OpsVerdictStrip; steps Build → Verify image → Pin → Live; runs list is bifrost-deliver-research only',
      'Launch Plugin: LaneStateStrip + AI Launch Plugin (+ Evidence links); Step observe-only (agent-driven); not Tekton',
      'Launch Agent: LaneStateStrip + AI Launch Agent (+ Evidence links); Step observe-only (agent-driven); deploy_mac_mini.sh; Toolbox = Direct Deploy / Manual Update escape',
    ],
  },
  {
    act: 'Body',
    ...
    examples: [
      ...
      'Launch Plugin: agent-driven — AI Launch Plugin on LaneStateStrip; Step detail observe-only (Detect→Live); Record / manual evidence in Toolbox; light checklist + Dock approvals',
      'Launch Agent: agent-driven — AI Launch Agent on LaneStateStrip; Step detail observe-only (Detect→Deploy→Live); Direct Deploy + Record + Manual Update in Toolbox; Dock approvals',
  ...
  },
  {
    ...
    rules: [
      ...
      'Rocket / Satellite / Research / Plugin / Agent lane operate pages: LaneStateStrip is the Verdict equivalent — page-level Agent CTA must stay on the strip (AI Release / AI Deploy / AI Deploy Research / AI Launch Plugin / AI Launch Agent), not inside Advanced recovery',
