...
export const MARKET_DATA_PHASES: MarketDataPhase[] = [
  ...
  },
  {
    ...
    summary: 'raw_market.* + ops_jobs.* schemas; roles; SCHEMA.md.',
  ...
  },
  {
    ...
    summary: 'Polygon → raw_market.* upsert for stock/option/corporate/calendar.',
  ...
  },
  {
    ...
    summary: 'Historical depth + freshness probe via ops_jobs.ingest_freshness (Wave 8: data_ops shim retired).',
  ...
  },
  {
    ...
    summary: 'Trade readers → raw_market.*; Celery massive queues retired.',
    deliverable: 'Trade API/Frontend on raw_market.* schema',
    status: 'done',
  },
  {
    id: 'P9',
...
export const MARKET_DATA_DESIGN_PRINCIPLES = [
  ...
  'PG-as-broker — ops_jobs.job_ingest with SELECT FOR UPDATE SKIP LOCKED; no Celery Beat.',
  'Schema isolation — raw_market.* (public data) + features.option_metric_* (derived) + ops_jobs.* (jobs/ops); single Polygon vendor.',
  ...
  'Fundamentals-rotate — CS universe (raw_market.ticker) financials catch-up; missing income_statement first; skip non-trading days unless --force.',
...
export const PG_SCHEMA_CONTRACT = {
  ...
  marketTables: [
    ...
    'raw_market.stock_financials', // compat view (Wave 8)
