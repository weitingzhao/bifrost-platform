...
export const MARKET_DATA_RELATED_AUTHORITIES = [
  ...
  'Library SLA: ticker_sync <24h · financials cadence <24h · CS financials catch-up then daily rotate · related-companies rotate ≤7 trading days · ticker_type dictionary on-demand (reference + fundamentals-rotate + related-rotate CronJobs; image bifrost-market-data:0.7.5)',
