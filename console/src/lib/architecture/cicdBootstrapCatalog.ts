...
export const BOOTSTRAP_LAYERS: BootstrapLayerDef[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: 'Tekton pipeline bifrost-deliver-platform', status: 'deployed' },
...
export const CICD_GAPS: CicdGap[] = [
  ...
  },
  {
    id: 'platform-prod',
    layer: 'L1',
    gap: 'Platform only deployed to stg; no prod overlay or HA',
  ...
  },
  {
    id: 'self-health',
    layer: 'L1',
    gap: 'Platform does not probe its own health (circular but essential)',
  ...
  },
  {
    id: 'gate-spine',
    layer: 'L2',
    gap: 'promotion.last_gate in spine is always null; release gate results not persisted',
