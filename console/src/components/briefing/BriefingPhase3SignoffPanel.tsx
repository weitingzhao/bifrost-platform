...
import {
  ...
  type BriefingPhase3SignoffState,
} from '@/lib/briefing/briefingPhase3Delivery'

export function BriefingPhase3SignoffPanel() {
  const { canAdmin, caps } = usePlatformAuth()
  const [state, setState] = useState<BriefingPhase3SignoffState>(() => loadPhase3SignoffState())
  ...
  function handleSignOff() {
    persist({
      ...
      note: 'Phase 2 closed-loop delivery — Owner UI sign-off',
    })
      ...
      {panelExpanded && (
        <div className="mt-3 flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2">
            {BRIEFING_PHASE3_DELIVERY_ITEMS.map(item => {
