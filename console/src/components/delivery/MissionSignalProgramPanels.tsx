  ...
  return (
    <section className="page-section panel-elevated px-2 py-2 flex flex-col gap-3">
      ...
      <p className="text-dense-meta text-muted-foreground m-0 px-3">
        Live readiness from Control Room probes and governance APIs. Sign off each phase when acceptance criteria are met.
        Phase table above syncs from unified programs API.
      </p>
