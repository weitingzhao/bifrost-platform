...
import { blockerRequiresManualPath, manualPrimaryCtaLabel } from '@/lib/control-room/dailyOpsPrimaryBlocker'
...
/** Reasons longer than this stay collapsed by default. */
  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-1.5">
        ...
        <span className="shrink-0 font-mono text-[var(--text-dense-micro)] uppercase text-muted-foreground">
          {s.signal}
        </span>
        <span
          className={cn(
      ...
      {reason !== '' && (!hasLongNote || noteOpen) && (
        <p className="m-0 mt-0.5 pl-4 text-[var(--text-dense-caption)] text-muted-foreground">
          {reason}
        </p>
      )}
    </div>
...
export function DailyOpsFleetCellDetail({
  ...
  return (
    <div
      ...
      className="flex max-h-[min(22rem,42vh)] min-w-0 max-w-full flex-col overflow-hidden rounded-lg border border-border bg-secondary"
    >
